...
public class WorkoutsFragment extends Fragment {
    ...
    private List<Workouts> workoutList; // Your data source
    ...
    private void loadWorkouts() {
        Handler handler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == HttpURLConnection.HTTP_OK) {
                    ...
                    recyclerView.setAdapter(workoutsAdapter); // Set the adapter to the RecyclerView
                    ...
                    workoutsAdapter.setOnItemClickListener(new WorkoutsAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(Workouts workout) {
                            ...
                            intent.putExtra("creator", workout.getCreator());// Pass the workout id
                    ...
                    Log.d("WorkoutsFragment", "GET request not worked");
                }
            }
        };
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    URL url = new URL("http://10.0.2.2:8080/api/users/admin@fitflow.com/workoutsdto");
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        // Parse the JSON response and add the workouts to the list
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            workoutList.add(new Workouts(title, creator, workoutId));
                        }

                        // Send a message to the handler
                        handler.sendEmptyMessage(HttpURLConnection.HTTP_OK);
                    } else {
                        Log.d("WorkoutsFragment", "GET request not worked. Response code: " + responseCode);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
